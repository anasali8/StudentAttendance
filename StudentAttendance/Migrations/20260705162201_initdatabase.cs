        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssociatedId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fingerprints", x => x.StudentId);
                    table.ForeignKey(
                        name: "FK_Fingerprints_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    NextLectureDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AbsenceProbability = table.Column<decimal>(type: "decimal(5,4)", precision: 5, scale: 4, nullable: false),
                    RiskFlag = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Predictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Predictions_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LatenessClassification = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_LectureSessions_LectureSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_LectureSessionId_StudentId",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectureSessions_CourseId",
                table: "LectureSessions",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_CourseId",
                table: "Predictions",
                column: "CourseId");
